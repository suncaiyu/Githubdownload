...
public:
    ...
    //设置、获取节点存的数据指针
    void setItemData(QString name, QString data) { mItemData[name] = data; };
    QMap <QString, QString> ItemData() { return mItemData; };
